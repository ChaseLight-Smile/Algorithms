...
public class ZOJ1001 {
	...
	*/		
	...
	/** hdu1003
	 * Problem: Given a sequence a[1],a[2],a[3]......a[n], your job is to calculate the max sum of a sub-sequence. For example, given (6,-1,5,4,-7), the max sum in this sequence is 6 + (-1) + 5 + 4 = 14.
	 ...
	 * 本质最大子数组问题，代码之前已经写过，参见MaxSubArray.java文件
	 */
	public static void HDU1003Solution(){
		//参见MaxSubArray.java文件
	}
}
